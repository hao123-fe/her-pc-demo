...
},{"./Controller":3,"./Requestor":7,"./Resource":8}],2:[function(require,module,exports){
...
},{"./EventEmitter":4}],3:[function(require,module,exports){
...
},{"./Pagelet":6,"./Resource":8}],4:[function(require,module,exports){
/**
 * 事件机制实现
 *
 * @class
     ...
     */
    {
        ...
        arrive: function (config) {
            copyProperties(this, {
                 ...
                 * @member {Boolen}
                 */
                quickling: config.quickling || false
            })
            /**
...
},{"./EventEmitter":4,"./Resource":8}],7:[function(require,module,exports){
//var Pagelet = require("./Pagelet");
var Controller = require("./Controller");
    ...
    */
    ...
    _fetch : function(pagelets, url, callback, cached){
        ...
        ajax(url, function(text){
            ...
            if(cached && cached.length) data = data.concat(cached);
            //console.log(data);
            parseData(data);
        });
        ...
        function parseData(data){
            for(var i = 0; i < data.length; i++){
                ...
                var conf = data[i];
                if(conf.html.html) conf.html = conf.html.html;
                //conf.html = conf.html.html;
                //if(!this.cacheData[url]) this.cacheData[url] = {};
                if(!cache[conf.id]) cache[conf.id] = conf;
...
},{"./Controller":3}],8:[function(require,module,exports){
var EventEmitter = require("./EventEmitter");
    ...
    if (type(map) === 'object') {
        ...
        for (var id in map) {
            if (!hasOwnProperty(_resourceMap, id)) {
                _resourceMap[id] = map[id];
            }
        }
        each(_resourceMap, function (value, key, obj) {
            each(value, function (v, k, o) {
                if (k === 'mods' && v.length > 0) {
                    each(v, function (item, index, v) {
                        _nameMap[item] = key;
                    })
                }
            })
...
},{"./CSSLoader":2,"./EventEmitter":4,"./JSLoader":5}],9:[function(require,module,exports){
(function (global){
